from execution.audit_engine.collectors import Layer4Collector
...
def main():
    ...
    print(f"Testing Layer 4 Collector for {submission.website_url}...")
    collector = Layer4Collector(submission)
