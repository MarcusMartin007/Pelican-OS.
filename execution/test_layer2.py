from execution.audit_engine.collectors import Layer2Collector
...
def main():
    ...
    print(f"Testing Layer 2 Collector for {submission.website_url}...")
    collector = Layer2Collector(submission)
