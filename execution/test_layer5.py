from execution.audit_engine.collectors import Layer5Collector
...
def main():
    ...
    print(f"Testing Layer 5 Collector for {submission.website_url}...")
    collector = Layer5Collector(submission)
